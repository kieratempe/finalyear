...
<body>
    <div class="sidebar">
        <div class="sidebar-links">
            <img src="img/logo.png" class="logo" alt="HR Harmony Logo"/>

            <div class="sidebar-item">
                <a href="#"><img src="img/icons/dashboard.svg" alt=""/> Dashboard</a>
            </div>

            <div class="sidebar-item">
                <a href="#"><img src="img/icons/tasks.svg" alt=""/> Task</a>
            </div>

            <div class="sidebar-item">
                <a href="#"><img src="img/icons/appraisal.svg" alt=""/> Appraisal</a>
            </div>

            <div class="sidebar-item">
                <a href="#"><img src="img/icons/payment.svg" alt=""/> Payslip</a>
            </div>

            <div class="sidebar-item">
                <a href="#"><img src="img/icons/training.svg" alt=""/> Training</a>
            </div>

            <div class="sidebar-item">
                <a href="#"><img src="img/icons/account.svg" alt=""/> Account</a>
            </div>

            <div class="sidebar-item">
                <a href="logout.php"><img src="img/icons/exit.svg" alt=""/> Logout</a>
            </div>
        </div>
    </div>
    ...
    <div class="card-section">
        ...
        <div class="card">
            ...
            <h2>120</h2> <!-- Replace with dynamic data -->
        ...
        <div class="card">
            ...
            <h2>8</h2> <!-- Replace with dynamic data -->
        ...
        <div class="card">
            ...
            <h2>3</h2> <!-- Replace with dynamic data -->
        ...
        <div class="card">
            ...
            <h2>95%</h2> <!-- Replace with dynamic data -->
